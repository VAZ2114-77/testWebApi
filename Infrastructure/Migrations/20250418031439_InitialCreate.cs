    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContentTypesContentTypeID = table.Column<int>(type: "int", nullable: false),
                    PermissionsPermissionID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContentTypePermission", x => new { x.ContentTypesContentTypeID, x.PermissionsPermissionID });
                    table.ForeignKey(
                        name: "FK_ContentTypePermission_ContentTypes_ContentTypesContentTypeID",
                        column: x => x.ContentTypesContentTypeID,
                        principalTable: "ContentTypes",
                        principalColumn: "ContentTypeID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContentTypePermission_Permissions_PermissionsPermissionID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentTypePermission_PermissionsPermissionID",
